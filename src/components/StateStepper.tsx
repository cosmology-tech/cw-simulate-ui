...
const StateStepper = ({currentState, setCurrentState, allStates, setResponse, setPayload, setCurrentTab}:IProps) => {
  ...
  return (
      allStates.length ? <Steps current={currentState} onChange={onChange} size="small" style={{margin:'20px'}}>
        {
